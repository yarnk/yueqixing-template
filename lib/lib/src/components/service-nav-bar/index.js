...
class ServiceNavBar extends react_1.Component {
    ...
    render() {
        ...
        return (react_1.default.createElement(components_1.Block, null, react_1.default.createElement(components_1.View, { style: nav_bar_style, className: "service-nav-bar" }, react_1.default.createElement(components_1.View, { className: "nav-address", onClick: this.chooseLocation }, react_1.default.createElement(taro_ui_1.AtIcon, { value: "map-pin", size: "small" }), react_1.default.createElement(components_1.Text, null, this.subString(location)), react_1.default.createElement(taro_ui_1.AtIcon, { value: clicked ? "chevron-up" : "chevron-down", size: 10 }))), react_1.default.createElement(components_1.View, { style: nav_bar_style })));
    }
}
