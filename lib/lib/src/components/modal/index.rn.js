...
const TaroModal = (props) => {
    ...
    }, props, { closable: false }), !closable && (react_1.default.createElement(components_1.View, { className: `close-icon-box ${closeIconName}`, onClick: onClose, style: closeIconStyle }, react_1.default.createElement(components_1.Image, { src: constant_1.CLOSE_ICON, className: "close-icon" }))), react_1.default.createElement(components_1.View, { className: "taro-modal-content" }, props.children)));
};
TaroModal.options = {
    addGlobalClass: true,
};
