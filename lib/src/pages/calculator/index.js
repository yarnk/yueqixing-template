...
class HouseLoanCompute extends react_1.Component {
    ...
    render() {
        ...
        return (react_1.default.createElement(_components_1.SafeAreaView, { className: "calculator" },
            react_1.default.createElement(_components_1.StatusBar, { backgroundColor: backgroundColor, barStyle: "dark-content" }),
            keyboardHeight >= 0 && (react_1.default.createElement(components_1.View, { className: "fixed" },
                react_1.default.createElement(components_1.View, { className: "mask" }),
                react_1.default.createElement(components_1.View, { className: "keyboard-box", style: {
                        bottom: (0, _utils_1.isAndriod)() ? 0 : keyboardHeight
                    } },
                    react_1.default.createElement(components_1.Text, { className: "keyboard-box-text" }, "\u8BF7\u8F93\u5165"),
                    react_1.default.createElement(_components_1.KeyboardAwareScrollView, { keyboardShouldPersistTaps: "always", enableAutomaticScroll: false, onKeyboardDidShow: this.onKeyboardDidShow, className: "keyboard-box-view", onKeyboardDidHide: this.onKeyboardDidHide },
                        react_1.default.createElement(components_1.Input
                        // @ts-ignore
                        , {
                            // @ts-ignore
                    ...
                    react_1.default.createElement(components_1.Text, { className: "keyboard-box-confirm", onClick: this.downPayRateConfirm }, "\u786E\u5B9A")))),
            react_1.default.createElement(_components_1.KeyboardAwareScrollView, { innerRef: (ref) => {
                    this.scroll = ref;
                }, style: { flex: 1 } },
                showResult && (react_1.default.createElement(compute_header_1.default, { way: way, tip: this.getTip(), downPayRate: downPayRate, equalInterestPayMonth: equalInterestPayMonth, equalPrincipalPayMonth: equalPrincipalPayMonth, houseTotal: houseTotal, userLoanWay: userLoanWay, goHistory: this.goPage("history"), goMonthlyPayments: this.goPage("monthly-payments", this.computeResult) })),
                react_1.default.createElement(components_1.View, { className: "content" },
                    react_1.default.createElement(title_tpl_1.TitleTpl, { title: "\u8BA1\u7B97\u65B9\u5F0F", data: constans_1.COMPUTE_WAY_TITLE, onWayClick: this.onWayClick, activeIndex: way }),
                    react_1.default.createElement(line_wrap_1.LineWrap, { data: renderList, type: constans_1.COMPUTE_WAY[way], onChangePicker: this.onChangePicker, onInputChange: this.onInputChange }),
                    react_1.default.createElement(title_tpl_1.TitleTpl, { title: "\u8D37\u6B3E\u65B9\u5F0F", data: constans_1.LOAN_WAY_TITLE, onWayClick: this.onWayClick, activeIndex: loanType }),
                    react_1.default.createElement(line_wrap_1.LineWrap, { data: renderList, type: constans_1.LIST_TYPE[loanType], onBlur: this.checkAccumulatLoanAmount, onChangePicker: this.onChangePicker, onInputChange: this.onInputChange }),
                    react_1.default.createElement(components_1.Video, { className: "video", src: constans_1.DEMO_VIDEO, controls: false, showFullscreenBtn: false, autoplay: true, loop: true, muted: true }))),
            react_1.default.createElement(_components_1.BoxShadow, { shadowColor: "#000", shadowOffset: {
                    width: 0,
                    height: -1
                }, shadowOpacity: 0.1, shadowRadius: 1, elevation: 5, className: "compute", style: {
                    opacity: btnOpacity,
                }, boxShadow: "0px 2px 8px 0px rgba(211,215,218,1)" },
                react_1.default.createElement(_components_1.SafeAreaView, null,
                    react_1.default.createElement(components_1.View, { className: "compute-btn", onClick: this.submit },
                        react_1.default.createElement(components_1.Text, { className: "compute-btn-text" }, "\u5F00\u59CB\u8BA1\u7B97"))))));
    }
}
