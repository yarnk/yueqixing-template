...
const TaroLinearGradient = props => {
    ...
    if (IS_RN) {
        ...
        return (react_1.default.createElement(components_1.View, { className: `linear-gradient__box ${className}`, style: propsStyle, onClick: onClick },
            react_1.default.createElement(components_1.Image, { src: src, className: "linear-gradient__box__img" }),
            props.children));
    }
    ...
    return (react_1.default.createElement(components_1.View, { className: `linear-gradient__box ${IS_WEAPP ? "^" : ""}${className}`, style: Object.assign(Object.assign({}, (!src ? { background } : "")), style) },
        src && (react_1.default.createElement(components_1.Image, { src: src, mode: "aspectFill", className: "linear-gradient__box__img" })),
        props.children));
};
