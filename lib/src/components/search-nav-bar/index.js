...
class SearchNavBar extends react_1.Component {
    ...
    render() {
        ...
        return (react_1.default.createElement(components_1.Block, null,
            react_1.default.createElement(components_1.View, { style: nav_bar_style, className: "search-nav-bar" },
                react_1.default.createElement(taro_ui_1.AtTabs, { className: "nav-tabs", current: current, tabList: tabList, onClick: this.handleClick.bind(this) })),
