...
class HomeNavBar extends react_1.Component {
    ...
    render() {
        ...
        return (react_1.default.createElement(components_1.Block, null,
            react_1.default.createElement(components_1.View, { style: nav_bar_style, className: "home-nav-bar" },
                react_1.default.createElement(components_1.Image, { onClick: this.handleAvatarClick, className: "avatar-my", src: userInfo.avatar }),
                react_1.default.createElement(components_1.Navigator, { url: "/pages/search/index", className: "input" },
                    react_1.default.createElement(taro_ui_1.AtIcon, { className: "icon", size: "18", color: "#666", value: "search" }),
                    react_1.default.createElement(components_1.Text, { className: "txt" }, "\u641C\u70B9\u597D\u73A9\u7684 100+"))),
